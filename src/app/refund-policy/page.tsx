  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">Digital Download ($0.99)</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">Printed & Ready ($0.99)</h2>
          <p>
