...
const FAQS = [
  ...
  { q: 'What format do I receive my files in?', a: 'Digital Download ($4.99): a high-res JPEG plus a print-ready 4×6 PDF with multiple copies tiled. Printed & Ready ($8.99): two physical prints at a nearby CVS or Walgreens.' },
