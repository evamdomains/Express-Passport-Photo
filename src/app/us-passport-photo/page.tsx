...
export const metadata: Metadata = {
  ...
  description:
    'Get a compliant US passport photo in 60 seconds. 2×2 inches, white background, ICAO compliant. Instant download $6.99. Meets all State Department requirements.',
  alternates: { canonical: 'https://expresspassportphoto.com/us-passport-photo' },
  openGraph: {
    title: 'US Passport Photo — $6.99 | Express Passport Photo',
...
const FAQS = [
  ...
  { q: 'What format do I receive my files in?', a: 'Digital Download ($6.99): a high-res JPEG plus a print-ready 4×6 PDF with multiple copies tiled. Printed & Ready ($12.99): two physical prints at a nearby CVS or Walgreens.' },
