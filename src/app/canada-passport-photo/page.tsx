...
export const metadata: Metadata = {
  title: 'Canadian Passport Photo Online — $0.99 | 50×70mm, IRCC Compliant',
  description:
    'Get a compliant Canadian passport photo in 60 seconds. 50×70mm, white background, face height 31–36mm. Meets IRCC requirements. Instant download $0.99.',
  alternates: { canonical: 'https://expresspassportphoto.com/canada-passport-photo' },
  openGraph: {
    title: 'Canadian Passport Photo — $0.99 | Express Passport Photo',
